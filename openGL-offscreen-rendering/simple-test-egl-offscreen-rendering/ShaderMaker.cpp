...
const char* shader_maker::readShaderSource(const char* shaderFile)
{
...
const GLuint shader_maker::createProgram(char* vertexfilename, char *fragmentfilename)
{
	...
	const GLchar* VertexShader = shader_maker::readShaderSource(vertexfilename);
