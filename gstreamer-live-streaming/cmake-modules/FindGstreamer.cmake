...
MESSAGE(STATUS "GStreamer found: ${PKG_GSTREAMER_INCLUDE_DIRS}")
...
IF(NOT GSTREAMER_WEBRTC_INCLUDE_DIR)
  MESSAGE(STATUS "GStreamer: WARNING: gst/webrtc/webrtc_fwd.h not found")
ENDIF(NOT GSTREAMER_WEBRTC_INCLUDE_DIR)
...
IF(NOT GSTREAMER_WEBRTC_FOUND)
    MESSAGE(STATUS "GStreamer: ERROR: webRTC libraries not found")
ENDIF(NOT GSTREAMER_WEBRTC_FOUND)
