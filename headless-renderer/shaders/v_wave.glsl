...
uniform mat4 P; // Prjection
uniform mat4 V; // View
uniform mat4 M; // Model: position*rotation*scaling
uniform float time;
uniform float a;
uniform float h;
...
//then handle lighting as in gouraud
	...
	vec3 E = normalize(-eyePosition.xyz); //zero(Camera) - eyePosition
